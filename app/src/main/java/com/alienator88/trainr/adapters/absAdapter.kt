...
class absAdapter(val arrayList: ArrayList<Model>, val context: Context) : RecyclerView.Adapter<absAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        //holder.itemView.imageIv.startAnimation(loadAnimation(context, R.anim.fade_transition_img))
